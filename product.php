                        ...
                        if (isset($_GET["tim"])) {
                            ...
                            <div class="pageination">
                                <nav aria-label="Page navigation example">
                                    ...
                                    ?>
                                        <li class="page-item">
                                            <a class="page-link" href="?tim=<?=$keyword?>&per_page=<?=$item_per_page?>&page=<?=$prev_page?>" aria-label="Next">
                                    ...
                                    ?>
                                        <li class="page-item">
                                            <a class="page-link" href="?tim=<?=$keyword?>&per_page=<?=$item_per_page?>&page=<?=$next_page?>" aria-label="Previous">
